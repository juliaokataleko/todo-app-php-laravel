                ...
                <form method="POST" action="{{ BASE_URL }}/profile/edit">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            ...
                            <small id="passwordHelpBlock" class="form-text text-muted">
                                O usuário não deve conter espaços ou caracteres especiais. Apenas letras, números e
                                underline(_)
                            </small>
                    ...
                    <div class="form-group">
                        <div class="">
                            ...
                            <input id="birth_day" placeholder="Aniversário" type="date"
                                class="form-control @error('birth_day') is-invalid @enderror" name="birth_day"
                                value="{{ $user->birth_day }}" autocomplete="off">
                    ...
                    <div class="form-group">
                        <div class="">
                            <label for="birth_place">Local</label>
                            <input id="birth_place" placeholder="Cidade" type="text"
                                class="form-control @error('birth_place') is-invalid @enderror" name="birth_place"
                                value="{{ $user->birth_place }}" autocomplete="off">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" {{ ($user->gender == 'm') ? 'checked': '' }} type="radio"
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="gender"
                            {{ ($user->gender == 'f') ? 'checked': '' }} id="gender2" value="f">
