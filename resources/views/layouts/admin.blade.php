...
<body style="margin-top:3em; background: #eee">
    ...
    navbar-dark " style="background: #055ce9;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ BASE_URL }}/"> <i class="fa fa-home"></i> Início</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="{{ BASE_URL }}/admin/config">Configurações</a>
                </li>
            </ul>
